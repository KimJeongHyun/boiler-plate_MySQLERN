                ...
                if (err){
                    ...
                    crypto.randomBytes(64,(err,buf)=>{
                        crypto.pbkdf2(userpw,buf.toString('base64'),108326,64,'sha512',(err,key)=>{
                            ...
                            connection.query('INSERT INTO USERS (id, pw, uname, birth, mail, phone, address, nick, salt) VALUES(?,?,?,?,?,?,?,?,?)',[userid,hashedpw,username,birth,mail,phone,address,nickname,salt], (err,data)=>{
                                if (err) throw err;
                            });
                        });
                    });
